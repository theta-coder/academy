      ...
      <div class="flex-1 px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <div class="md:hidden space-y-3 sm:space-y-4">
          ...
          <div v-else-if="mobileStudents.length === 0" class="text-center py-12 bg-white rounded-lg shadow">
            ...
            <p class="mt-2 text-sm font-medium text-gray-500">No students found</p>
            <p class="mt-1 text-xs text-gray-400">Try adjusting your filters</p>
          </div>

          <!-- Student Cards -->
          <div v-else v-for="(student, index) in mobileStudents" :key="student.id" class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            <div class="p-4">
              <!-- Header -->
      ...
      <Modal :show="showDeleteModal" @close="showDeleteModal = false">
        ...
        <template #footer>
          <div class="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3">
            ...
            >
              <span v-if="!deleting">Delete Student</span>
