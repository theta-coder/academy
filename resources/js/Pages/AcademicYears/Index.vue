      ...
      <div class="flex-1 px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <div class="mb-4 sm:mb-6 lg:mb-8">
          <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            ...
            <Button
              @click="$inertia.visit(route('academic-years.create'))"
              variant="primary"
            ...
            <table id="academic-years-table" class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gradient-to-r from-indigo-50 to-blue-50">
                <tr>
                  ...
                  <th class="px-3 sm:px-6 py-3 sm:py-4 text-xs font-semibold text-gray-700 uppercase tracking-wider text-center">Year Name</th>
                  <th class="px-3 sm:px-6 py-3 sm:py-4 text-xs font-semibold text-gray-700 uppercase tracking-wider text-center">Start Date</th>
                  <th class="px-3 sm:px-6 py-3 sm:py-4 text-xs font-semibold text-gray-700 uppercase tracking-wider text-center">End Date</th>
                  <th class="px-3 sm:px-6 py-3 sm:py-4 text-xs font-semibold text-gray-700 uppercase tracking-wider text-center">Duration</th>
          ...
          <div v-else v-for="(year, index) in mobileYears" :key="year.id" class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            <div class="p-4">
              ...
              <div class="flex gap-2 mt-4 pt-3 border-t border-gray-100">
                ...
                <button
                  @click="$inertia.visit(route('academic-years.edit', year.id))"
...
onMounted(() => {
  ...
  table = $('#academic-years-table').DataTable({
    ...
    drawCallback: function () {
      $('#table-info').empty().append($('#academic-years-table_info'))
      $('#table-pagination').empty().append($('#academic-years-table_paginate'))
    }
  })
})
...
window.editYear = (year) => {
  router.visit(route('academic-years.edit', year.id))
}
...
@media (max-width: 1024px) {
  :deep(#academic-years-table) { font-size: 0.813rem; }
  :deep(#academic-years-table th),
  :deep(#academic-years-table td) { padding: 0.5rem; }
}
</style>