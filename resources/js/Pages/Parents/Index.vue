      ...
      <div class="flex-1 px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <div class="md:hidden space-y-3 sm:space-y-4">
          ...
          <div v-else-if="mobileParents.length === 0" class="text-center py-12 bg-white rounded-lg shadow">
            ...
            <p class="mt-2 text-sm font-medium text-gray-500">No parents found</p>
            <p class="mt-1 text-xs text-gray-400">Try adjusting your filters</p>
          </div>

          <!-- Parent Cards -->
          <div v-else v-for="(parent, index) in mobileParents" :key="parent.id" class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            <div class="p-4">
              <!-- Header -->
              <div class="flex items-start justify-between mb-3">
                <div class="flex-1">
                  <div class="flex items-center gap-2">
                    ...
                    <h3 class="text-base font-semibold text-gray-900">{{ parent.father_name }}</h3>
                  </div>
              ...
              <div class="space-y-2 border-t border-gray-100 pt-3">
                ...
                <div class="flex items-center text-xs sm:text-sm">
                  ...
                  <span class="text-gray-600">{{ parent.city || 'N/A' }}</span>
                </div>
      ...
      <Modal :show="showDeleteModal" @close="showDeleteModal = false">
        ...
        <template #footer>
          <div class="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3">
            ...
            >
              <span v-if="!deleting">Delete Parent</span>
